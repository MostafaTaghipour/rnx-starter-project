...
export const HttpStatusCodeUtils = {
    isInformationalResponses(statusCode:HttpStatusCode): boolean{
        return (statusCode >= 100 && statusCode < 200) 
    },
    isSuccess (statusCode:HttpStatusCode): boolean{
		return (statusCode >= 200 && statusCode < 300) 
    },
    isRedirection(statusCode:HttpStatusCode): boolean{
		return (statusCode >= 300 && statusCode < 400) 
    },
    isClientError(statusCode:HttpStatusCode): boolean{
		return (statusCode >= 400 && statusCode < 500) 
    },
    isServerErrors(statusCode:HttpStatusCode): boolean{
