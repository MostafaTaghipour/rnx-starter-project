...
import { StyleProp, ViewStyle, TouchableWithoutFeedback, FlatList } from 'react-native';
...
export default class PickerField extends React.Component<Props, State> {
	...
	private returnData(index: number, value: string) {
...
export class PickerModalScreen extends React.Component<ModalProps, ModalState> {
	...
	private searchFilterFunction(text: string) {
