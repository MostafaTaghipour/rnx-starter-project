...
export default (variables /*: * */ = variable) => {
	...
	const headerTheme = {
		...
		'NativeBase.Left': {
			...
			alignSelf: variables.isPWAiPhoneX ? 'flex-end' : 'center',
			paddingBottom: variables.isPWAiPhoneX ? 7 : 0,
			flex: 1,
			alignItems: 'flex-start',
		},
		'NativeBase.Body': {
			...
			alignItems: 'center',
			alignSelf: variables.isPWAiPhoneX ? 'flex-end' : 'center',
			paddingBottom: variables.isPWAiPhoneX ? 14 : 0,
			'NativeBase.Segment': {
				borderWidth: 0,
				alignSelf: 'flex-end',
		...
		// paddingBottom: 10,
		borderBottomWidth: variables.toolbarBorderWidth,
		borderBottomColor: variables.toolbarBorderColor,
		height:
		...
		marginTop: variables.isPWAiPhoneX ? -32 : 0,
		top: 0,
		left: 0,
		right: 0,
	};
