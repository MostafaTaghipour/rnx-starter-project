...
export default {
	//Color
	get brandDark() {
		return R.colors.appleNightLightColor;
	},
	get brandLight() {
		return R.colors.appleNightDarkColor;
	},

	//Container
	get containerBgColor() {
		return R.colors.appleNightBackgroundColor;
	},

	//Card
	get cardDefaultBg() {
		return R.colors.appleNightSurfaceColor;
	},
	get cardBorderColor() {
	...
	get tabBarTextColor() {
		return R.colors.appleNightLowLightColor;
	},
	get activeTab() {
		return R.colors.appleNightLightColor;
	},
	...
	get listSeparatorBackgroundColor() {
		return R.colors.appleNightSurfaceColor;
	},
	get listSeparatorTextColor() {
		return R.colors.appleNightLowLightColor;
	},
