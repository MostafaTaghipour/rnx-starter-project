...
export default {
	//Color
	get brandDark() {
		return R.colors.materialNightLightColor;
	},
	get brandLight() {
		return R.colors.materialNightDarkColor;
	},

	//Container
	get containerBgColor() {
		return R.colors.materialNightBackgroundColor;
	},

	//Card
	get cardDefaultBg() {
		return R.colors.materialNightSurfaceColor;
	},
	get cardBorderColor() {
	...
	get tabBarTextColor() {
		return R.colors.materialNightLowLightColor;
	},
	get activeTab() {
		return R.colors.materialNightLightColor;
	},
